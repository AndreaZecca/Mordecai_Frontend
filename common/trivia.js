...
class Question {
  ...
  */
  checkSolution (answer, time) {
    ...
    return (this.solution && ((answer - 1) === this.getSolution()) && this.checkDeadline(time)) ? 1 : 0
  }
  ...
  */
  getSolution () {
    return this.solution && this.solution.solution ? this.solution.solution - 1 : undefined
  }
